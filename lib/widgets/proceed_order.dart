...
class ProceesOrder extends StatefulWidget {
  const ProceesOrder({super.key});

  @override
  State<ProceesOrder> createState() => _ProceesOrderState();
}

class _ProceesOrderState extends State<ProceesOrder> {
  @override
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Rs ${
                                            viewBasketProvide.currentIndexOfToggle == 0 ? viewBasketCData.DeliveryPrice.toString():
